...
class GeoEra5Dataset5D(Dataset):
    def __init__(self, transform=None, prefix=""):
        ...
        self.labels = np.array([1.0 if all(self.labels[i:i+5]) else 0.0 for i in range(len(self.labels) - 4)] + [0] * 4)
...
class GeoUkesmDataset5D(Dataset):
    def __init__(self, transform=None, prefix=""):
        ...
        self.labels = [1 if all(self.labels[i+1:i+5]) else 0 for i in range(len(self.labels) - 4)] + [0] * 4
